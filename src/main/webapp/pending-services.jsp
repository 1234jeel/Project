...
<body>
	...
	<div class="container-fluid bg-white pt-3 px-lg-5">
		<%
		List<BookService> list = BookingDao.pendingServiceBySid(s.getId());
		%>
		<%
		...
		<div class="row mx-n2">
			...
			%>
			<%
			Customer c = CustomerDao.getCutomerById(cid);
			%>
			...
			<div class="col-xl-2 col-lg-4 col-md-6 px-2">
				<div data-target-input="nearest">
					<input type="text" class="form-control p-4 datetimepicker-input"
						value="<%=c.getEmail()%>" data-target="#date"
						data-toggle="datetimepicker" />
				</div>
			</div>
			<div class="col-xl-2 col-lg-4 col-md-6 px-2">
				<div data-target-input="nearest">
					<input type="text" class="form-control p-4 datetimepicker-input"
						value="<%=c.getContact()%>" data-target="#date"
						data-toggle="datetimepicker" />
				</div>
			</div>
			<div class="col-xl-2 col-lg-4 col-md-6 px-2">
