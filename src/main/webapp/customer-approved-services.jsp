...
<body>
	...
	if (session.getAttribute("data") != null) {
		...
		response.sendRedirect("customer-approved-services.jsp");
	}
	%>
	<!-- Topbar Start -->
					...
					<div class="navbar-nav ml-auto py-0">
						...
						<div class="nav-item dropdown">
							...
							<div class="dropdown-menu rounded-0 m-0">
								...
								<a href="compeleted-service.jsp" class="dropdown-item">Completed</a>
							</div>
						</div>
						<div class="nav-item dropdown">
							<a href="#" class="nav-link dropdown-toggle"
	...
	<div class="container-fluid bg-white pt-3 px-lg-5">
		<%
		List<BookService> list = BookingDao.approvedServiceByCid(C.getId());
		%>
		<%
		...
		<div class="row mx-n2">
			...
			<div class="col-xl-2 col-lg-4 col-md-6 px-2">
				<div data-target-input="nearest">
					<input type="text" class="form-control p-4 datetimepicker-input"
						value="<%=c1.getEmail() %>" data-target="#date" data-toggle="datetimepicker" />
				</div>
			</div>
			<div class="col-xl-2 col-lg-4 col-md-6 px-2">
				<div data-target-input="nearest">
					<input type="text" class="form-control p-4 datetimepicker-input"
						value="<%=c1.getContact() %>" data-target="#date" data-toggle="datetimepicker" />
				</div>
			</div>
			<div class="col-xl-2 col-lg-4 col-md-6 px-2">
				<div data-target-input="nearest">
