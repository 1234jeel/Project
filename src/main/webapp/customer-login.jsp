...
<body>
		...
		<div class="position-relative px-lg-5" style="z-index: 9;">
			<nav
				...
				<a href="" class="navbar-brand">
					<h1 class="text-uppercase text-primary mb-1">Eserivce</h1>
				</a>
				...
				<div class="collapse navbar-collapse justify-content-between px-3"
					...
					<div class="navbar-nav ml-auto py-0">
						<a href="index.jsp" class="nav-item nav-link">Home</a> <a
							href="index.jsp" class="nav-item nav-link">About</a>
						<div class="nav-item dropdown">
							<a href="#" class="nav-link dropdown-toggle active"
								data-toggle="dropdown">Service</a>
							<div class="dropdown-menu rounded-0 m-0">
								<a href="serviceman-index.jsp" class="dropdown-item active">Car
									Services</a> <a href="serviceman-index.jsp" class="dropdown-item">Bike
									Services</a> <a href="serviceman-index.jsp" class="dropdown-item">pumlber</a>
								<a href="serviceman-index.jsp" class="dropdown-item">painter</a>
							</div>
						</div>
	...
	<form action="CustomerController" method="post">
		...
		<div Class="form-group">
			<input type="password" Class="form-control p-4" placehlder="password"
	...
	<div class="container-fluid bg-dark py-4 px-sm-3 px-md-5">
		...
		<p class="m-0 text-center text-body">
			Designed by <a href="https://htmlcodex.com">Thakar Jeel</a>
		</p>
	</div>
	<!-- Footer End -->
