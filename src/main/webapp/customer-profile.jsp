...
<body>
			...
			<nav
				...
				<div class="collapse navbar-collapse justify-content-between px-3"
					...
					<div class="navbar-nav ml-auto py-0">
						<a href="customer-index.jsp" class="nav-item nav-link">Home</a>
	...
	<div class="container-fluid page-header">
		<h1 class="display-3 text-uppercase text-uppercase text-white mb-3">Profile</h1>
	</div>
	<!-- page header end -->
		...
		<div Class="Container pt-5 pb-3">
			...
			<div Class="row">
				<div Class="col-log-12 mb-2">
					<div class="conatact-form-bg-light mb-4"style="padding: 30px;">
						<form action="CustomerController" method="post">
							<div Class="form-group"> <input type="text"
								Class="form-control p-4" value="<%=c.getName()%>" name="name"
								required="required">
					</div>
					...
					<div Class="form-group">
						<input type="email" Class="form-control p-4" name="email"
							value="<%=c.getEmail()%>" required="required">
					</div>
	...
	<div class="container-fluid bg-secondary py-5 px-sm-3 px-md-5"
		...
		<div class="row pt-5">
			<div class="col-lg-3 col-md-6 mb-5">
				...
				<p>
					<i class="fa fa-envelope text-white mr-3"></i>onlineservice231411@gmail.com
				</p>
	...
	<div class="container-fluid bg-dark py-4 px-sm-3 px-md-5">
		...
		<p class="m-0 text-center text-body">
			Designed by <a href="https://htmlcodex.com">Java code</a>
		</p>
	</div>
	<!-- Footer End -->
